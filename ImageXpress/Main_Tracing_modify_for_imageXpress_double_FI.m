...
well_col = ["02" "03" "04" "05" "06" "07" "08" "09" "10"]
well_row = ["D" "H"]
...
Image_Type = '_s1_w3.tif';     % use TL25 or YFP 
...
% I  = imread('Z:\MD\20201209-test_512\TimePoint_1\20201209-test_E09_w1.tif');
...
Params.remove_small_patch = 300;  % identified colony need to bigger than * pixel
%%% END
...
% imshow(BWfinal)
% figure
% imshowpair(I,BWfinal*0.3)
% 
% imwrite(uint16(I),'i.tif', 'tif' );
% imwrite(uint16(BWfinal),'BWfinal.tif', 'tif' );
% 
% 
...
[All_valid_area All_valid_area_RFP all_valid_area_GFP]= Modify_no_merge_Area_Curve_double(Budding,1:1000);
