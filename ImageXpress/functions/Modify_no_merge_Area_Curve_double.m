...
function [all_valid_area all_valid_area_RFP all_valid_area_GFP] =  Modify_no_merge_Area_Curve_double(Budding,I)
...
%     end
    ...
    area1_GFP = Get_Properities(1:length(Lineages_temp.Lineage_index), Lineages_temp.Lineage_index, 'GFP', Budding); 
    ...
    area1_GFP= area1_GFP.*double(~merge_temp);
    ...
    all_valid_area_GFP = [ all_valid_area_GFP table(area1_GFP', 'VariableNames',{['cell_cluster' num2str(i)]}) ]  ;  
