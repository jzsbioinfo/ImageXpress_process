...
date_folder = 'Z:\MD\Analysis_data_Zhisheng\11th_Test 10X 20X 40X MD\40X\mCherry\'
...
Path    = ['Z:\MD\11th_Test 10X 20X 40X MD\20191029-40x-time series_244\TimePoint_*\'];
...
for i =  start_time_point:Tif_Window.T
   ...
   img = imread([Files2(i).folder '/' Files2(i).name]);
   %img = im2double(img);
   imwrite(img,[date_folder char(well) '1' '.tif'], 'tif' );
