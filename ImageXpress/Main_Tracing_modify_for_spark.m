...
date_folder = '201909011analysis_of_20190814spark\'
...
Path    = ['Z:\20190816__Spark\Images\' Name_case_ori '\'];
...
mask = uint16(Modify_Clone_Mask_spark(imread([Files(i).folder '/' Files(i).name])));

mask
 % Specify the region that you want to look at by using "Rectangle" tool in ImageJ to get the pixel coordinate.

% use a square of 6000*6000, x=1710, y=2255
Tif_Window.xlim   = [mask(1)-1500 mask(1)+1500];      % [x x+w]
Tif_Window.ylim   = [mask(2)-1500 mask(2)+1500];      % [y y+h]
