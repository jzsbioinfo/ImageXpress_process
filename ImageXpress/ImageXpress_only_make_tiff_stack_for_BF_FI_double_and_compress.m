...
% 
well_row = ["A" "B" "C" "D" "E" "F"]
%well_row = flip(well_row)
%well_row = ["C"]
well_col = ["01" "02" "03" "04" "05" "06" "07" "08" "09" "10" ]
% well_col = [ "02"]
well_row = [ "G" "H"]
...
date_folder = 'Z:\MD\Analysis_data_Zhisheng\31th_20X\movie\'
...
outputVideo = VideoWriter([date_folder char(well) '_BF_DOUBLE_out.avi']);
outputVideo.FrameRate = 1;
open(outputVideo)



outputVideo_compress = VideoWriter([date_folder char(well) '_BF_DOUBLE_out_compress.avi']);
...
% 20x
fuse_image_less = Merge_only_for_BF_DOUBLE(I*3, I_FI*25, I_FI2*12);  % I*3, I_FI*30, I_FI2*12
